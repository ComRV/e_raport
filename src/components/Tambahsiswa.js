        ...
        <div className="container min-w-full grid grid-row-3 grid-flow-col gap-4 bg-login-pattern h-screen">
            ...
            <div className="absolute left-[220px] top-12 z-10 laptop:left-[300px]">
                ...
                <form onSubmit={Addsiswa}>
                    {msg === "Data siswa berhasil ditambah" ? <p className="font-sans font-medium text-green-500 bg-green-100 rounded-md pl-2 drop-shadow-md">{msg}</p> : <p className="font-sans font-medium text-red-500 bg-red-100 rounded-md pl-2 drop-shadow-md">{msg}</p>}
