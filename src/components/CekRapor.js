            ...
            <div className="flex flex-col m-auto">
                ...
                <form>
                    <div className="flex flex-col">
                        <input type="number" className="w-11/12 h-9 border-2 pl-3 border-slate-200 bg-gray-50 rounded-md m-auto focus:outline-blue-500 drop-shadow-lg tablet:w-5/6 laptop:w-2/4" placeholder="Masukkan nomor NISN anda disini" />
                        <button className="font-lato w-11/12 h-9 m-auto mt-3 rounded-md bg-blue-500 hover:bg-blue-600 active:bg-blue-700 duration-150 tablet:w-5/6  laptop:w-2/4">Cek NISN</button>
                    </div>
                </form>
            </div>
