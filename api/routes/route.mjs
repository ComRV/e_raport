...
import { tambahSiswa, daftarSiswa, ubahSiswa, hapusSiswa, ceknisn } from "../controller/siswacontroller.mjs";
...
router.get('/rapor/:id', raporpdf)
router.get('/cekrapor/:nisn', ceknisn)
